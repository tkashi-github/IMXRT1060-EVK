 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_disp_get_scr_act(lv_disp_t * disp)
{
 ...
 */
LV_FUNC_ATTR void lv_disp_load_scr(lv_obj_t * scr)
{
 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_disp_get_layer_top(lv_disp_t * disp)
{
    if(!disp) disp = lv_disp_get_default();
    if(!disp) {
 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_disp_get_layer_sys(lv_disp_t * disp)
{
    if(!disp) disp = lv_disp_get_default();
    if(!disp) {
 ...
 */
LV_FUNC_ATTR void lv_disp_assign_screen(lv_disp_t * disp, lv_obj_t * scr)
{
 ...
 */
LV_FUNC_ATTR lv_task_t * lv_disp_get_refr_task(lv_disp_t * disp)
{
    if(!disp) disp = lv_disp_get_default();
    if(!disp) {
 ...
 */
LV_FUNC_ATTR uint32_t lv_disp_get_inactive_time(const lv_disp_t * disp)
{
    if(!disp) disp = lv_disp_get_default();
    if(!disp) {
 ...
 */
LV_FUNC_ATTR void lv_disp_trig_activity(lv_disp_t * disp)
{
    if(!disp) disp = lv_disp_get_default();
    if(!disp) {
