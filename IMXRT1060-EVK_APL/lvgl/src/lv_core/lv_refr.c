 ...
 */
LV_FUNC_ATTR void lv_refr_init(void)
{
    /*Nothing to do*/
}
 ...
 */
LV_FUNC_ATTR void lv_refr_now(lv_disp_t * disp)
{
    if(disp) {
 ...
 * only one display)
 */
LV_FUNC_ATTR void lv_inv_area(lv_disp_t * disp, const lv_area_t * area_p)
{
 ...
 */
LV_FUNC_ATTR lv_disp_t * lv_refr_get_disp_refreshing(void)
{
    return disp_refr;
}
 ...
 */
LV_FUNC_ATTR void lv_refr_set_disp_refreshing(lv_disp_t * disp)
{
    disp_refr = disp;
}
 ...
 */
LV_FUNC_ATTR void lv_disp_refr_task(lv_task_t * task)
{
 ...
 */
LV_FUNC_ATTR static void lv_refr_join_area(void)
{
    uint32_t join_from;
    uint32_t join_in;
 ...
 */
LV_FUNC_ATTR static void lv_refr_areas(void)
{
    px_num = 0;
    uint32_t i;
 ...
 */
LV_FUNC_ATTR static void lv_refr_area(const lv_area_t * area_p)
{
 ...
 * @param area_p pointer to an area to refresh
 */
LV_FUNC_ATTR static void lv_refr_area_part(const lv_area_t * area_p)
{
 ...
 * @return
 */
LV_FUNC_ATTR static lv_obj_t * lv_refr_get_top_obj(const lv_area_t * area_p, lv_obj_t * obj)
{
 ...
 */
LV_FUNC_ATTR static void lv_refr_obj_and_children(lv_obj_t * top_p, const lv_area_t * mask_p)
{
 ...
 */
LV_FUNC_ATTR static void lv_refr_obj(lv_obj_t * obj, const lv_area_t * mask_ori_p)
{
 ...
 * Flush the content of the VDB
 */
LV_FUNC_ATTR static void lv_refr_vdb_flush(void)
{
    lv_disp_buf_t * vdb = lv_disp_get_buf(disp_refr);
