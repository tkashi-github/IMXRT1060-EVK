 ...
 */
LV_FUNC_ATTR void lv_style_init(void)
{
 ...
 */
LV_FUNC_ATTR void lv_style_copy(lv_style_t * dest, const lv_style_t * src)
{
 ...
 */
LV_FUNC_ATTR void lv_style_mix(const lv_style_t * start, const lv_style_t * end, lv_style_t * res, uint16_t ratio)
{
...
LV_FUNC_ATTR void lv_style_anim_init(lv_anim_t * a)
{
    lv_anim_init(a);
    a->start    = 0;
    a->end      = STYLE_MIX_MAX;
...
LV_FUNC_ATTR void lv_style_anim_set_styles(lv_anim_t * a, lv_style_t * to_anim, const lv_style_t * start, const lv_style_t * end)
{
 ...
 */
LV_FUNC_ATTR static void style_animator(lv_style_anim_dsc_t * dsc, lv_anim_value_t val)
{
 ...
 */
LV_FUNC_ATTR static void style_animation_common_end_cb(lv_anim_t * a)
{
