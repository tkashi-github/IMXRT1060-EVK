 ...
 *  STATIC VARIABLES
 **********************/
LV_BSS_ATTR static uint16_t entry_cnt;
 ...
 */
LV_FUNC_ATTR lv_img_cache_entry_t * lv_img_cache_open(const void * src, const lv_style_t * style)
{
    if(entry_cnt == 0) {
 ...
 */
LV_FUNC_ATTR void lv_img_cache_set_size(uint16_t new_entry_cnt)
{
 ...
 */
LV_FUNC_ATTR void lv_img_cache_invalidate_src(const void * src)
{
