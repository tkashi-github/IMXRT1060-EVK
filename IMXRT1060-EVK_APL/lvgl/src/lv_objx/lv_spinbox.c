 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_spinbox_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_spinbox_set_value(lv_obj_t * spinbox, int32_t i)
{
 ...
 * shown
 */
LV_FUNC_ATTR void lv_spinbox_set_digit_format(lv_obj_t * spinbox, uint8_t digit_count, uint8_t separator_position)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
    if(ext == NULL) return;
 ...
 */
LV_FUNC_ATTR void lv_spinbox_set_step(lv_obj_t * spinbox, uint32_t step)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
    if(ext == NULL) return;
 ...
 */
LV_FUNC_ATTR void lv_spinbox_set_range(lv_obj_t * spinbox, int32_t range_min, int32_t range_max)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
    if(ext == NULL) return;
 ...
 */
LV_FUNC_ATTR void lv_spinbox_set_padding_left(lv_obj_t * spinbox, uint8_t padding)
{
    lv_spinbox_ext_t * ext  = lv_obj_get_ext_attr(spinbox);
 ...
 */
LV_FUNC_ATTR int32_t lv_spinbox_get_value(lv_obj_t * spinbox)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
 ...
 * @param spinbox pointer to spinbox
 */
LV_FUNC_ATTR void lv_spinbox_step_next(lv_obj_t * spinbox)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
 ...
 * @param spinbox pointer to spinbox
 */
LV_FUNC_ATTR void lv_spinbox_step_prev(lv_obj_t * spinbox)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
    int32_t step_limit;
 ...
 * @param spinbox pointer to spinbox
 */
LV_FUNC_ATTR void lv_spinbox_increment(lv_obj_t * spinbox)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
 ...
 * @param spinbox pointer to spinbox
 */
LV_FUNC_ATTR void lv_spinbox_decrement(lv_obj_t * spinbox)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_spinbox_signal(lv_obj_t * spinbox, lv_signal_t sign, void * param)
{
...
LV_FUNC_ATTR static void lv_spinbox_updatevalue(lv_obj_t * spinbox)
{
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
