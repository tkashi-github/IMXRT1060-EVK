 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_line_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_line_set_points(lv_obj_t * line, const lv_point_t point_a[], uint16_t point_num)
{
 ...
 */
LV_FUNC_ATTR void lv_line_set_auto_size(lv_obj_t * line, bool en)
{
    lv_line_ext_t * ext = lv_obj_get_ext_attr(line);
 ...
 */
LV_FUNC_ATTR void lv_line_set_y_invert(lv_obj_t * line, bool en)
{
    lv_line_ext_t * ext = lv_obj_get_ext_attr(line);
 ...
 */
LV_FUNC_ATTR bool lv_line_get_auto_size(const lv_obj_t * line)
{
    lv_line_ext_t * ext = lv_obj_get_ext_attr(line);
 ...
 */
LV_FUNC_ATTR bool lv_line_get_y_invert(const lv_obj_t * line)
{
    lv_line_ext_t * ext = lv_obj_get_ext_attr(line);
 ...
 */
LV_FUNC_ATTR static bool lv_line_design(lv_obj_t * line, const lv_area_t * mask, lv_design_mode_t mode)
{
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_line_signal(lv_obj_t * line, lv_signal_t sign, void * param)
{
    lv_res_t res;
