 ...
 *  STATIC VARIABLES
 **********************/
LV_BSS_ATTR static lv_design_cb_t ancestor_bg_design;
LV_BSS_ATTR static lv_design_cb_t ancestor_bullet_design;
 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_cb_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_cb_set_text(lv_obj_t * cb, const char * txt)
{
 ...
 * @param txt the text of the check box. NULL to refresh with the current text.
 */
LV_FUNC_ATTR void lv_cb_set_static_text(lv_obj_t * cb, const char * txt)
{
    lv_cb_ext_t * ext = lv_obj_get_ext_attr(cb);
 ...
 *  */
LV_FUNC_ATTR void lv_cb_set_style(lv_obj_t * cb, lv_cb_style_t type, const lv_style_t * style)
{
    lv_cb_ext_t * ext = lv_obj_get_ext_attr(cb);
 ...
 */
LV_FUNC_ATTR const char * lv_cb_get_text(const lv_obj_t * cb)
{
    lv_cb_ext_t * ext = lv_obj_get_ext_attr(cb);
 ...
 *  */
LV_FUNC_ATTR const lv_style_t * lv_cb_get_style(const lv_obj_t * cb, lv_cb_style_t type)
{
 ...
 */
LV_FUNC_ATTR static bool lv_cb_design(lv_obj_t * cb, const lv_area_t * mask, lv_design_mode_t mode)
{
    bool result = true;
 ...
 * @param return true/false, depends on 'mode'
 */
LV_FUNC_ATTR static bool lv_bullet_design(lv_obj_t * bullet, const lv_area_t * mask, lv_design_mode_t mode)
{
    if(mode == LV_DESIGN_COVER_CHK) {
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_cb_signal(lv_obj_t * cb, lv_signal_t sign, void * param)
{
    lv_res_t res;
