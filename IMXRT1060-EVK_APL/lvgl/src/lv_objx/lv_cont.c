 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_cont_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_cont_set_layout(lv_obj_t * cont, lv_layout_t layout)
{
 ...
 */
LV_FUNC_ATTR void lv_cont_set_fit4(lv_obj_t * cont, lv_fit_t left, lv_fit_t right, lv_fit_t top, lv_fit_t bottom)
{
 ...
 */
LV_FUNC_ATTR lv_layout_t lv_cont_get_layout(const lv_obj_t * cont)
{
    lv_cont_ext_t * ext = lv_obj_get_ext_attr(cont);
    return ext->layout;
}
 ...
 */
LV_FUNC_ATTR lv_fit_t lv_cont_get_fit_left(const lv_obj_t * cont)
{
    lv_cont_ext_t * ext = lv_obj_get_ext_attr(cont);
    return ext->fit_left;
}
 ...
 * @return an element of `lv_fit_t`
 */
LV_FUNC_ATTR lv_fit_t lv_cont_get_fit_right(const lv_obj_t * cont)
{
    lv_cont_ext_t * ext = lv_obj_get_ext_attr(cont);
 ...
 * @return an element of `lv_fit_t`
 */
LV_FUNC_ATTR lv_fit_t lv_cont_get_fit_top(const lv_obj_t * cont)
{
    lv_cont_ext_t * ext = lv_obj_get_ext_attr(cont);
    return ext->fit_top;
}
 ...
 * @return an element of `lv_fit_t`
 */
LV_FUNC_ATTR lv_fit_t lv_cont_get_fit_bottom(const lv_obj_t * cont)
{
    lv_cont_ext_t * ext = lv_obj_get_ext_attr(cont);
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_cont_signal(lv_obj_t * cont, lv_signal_t sign, void * param)
{
    lv_res_t res;
 ...
 */
LV_FUNC_ATTR static void lv_cont_refr_layout(lv_obj_t * cont)
{
 ...
 */
LV_FUNC_ATTR static void lv_cont_layout_col(lv_obj_t * cont)
{
    lv_layout_t type = lv_cont_get_layout(cont);
    lv_obj_t * child;
 ...
 * @param cont pointer to an object which layout should be handled
 */
LV_FUNC_ATTR static void lv_cont_layout_row(lv_obj_t * cont)
{
    lv_layout_t type = lv_cont_get_layout(cont);
    lv_obj_t * child;
 ...
 * @param cont pointer to an object which layout should be handled
 */
LV_FUNC_ATTR static void lv_cont_layout_center(lv_obj_t * cont)
{
    lv_obj_t * child;
    const lv_style_t * style = lv_obj_get_style(cont);
    uint32_t obj_num         = 0;
 ...
 * @param cont pointer to an object which layout should be handled
 */
LV_FUNC_ATTR static void lv_cont_layout_pretty(lv_obj_t * cont)
{
 ...
 * @param cont pointer to an object which layout should be handled
 */
LV_FUNC_ATTR static void lv_cont_layout_grid(lv_obj_t * cont)
{
    lv_obj_t * child;
    const lv_style_t * style = lv_obj_get_style(cont);
 ...
 */
LV_FUNC_ATTR static void lv_cont_refr_autofit(lv_obj_t * cont)
{
    lv_cont_ext_t * ext = lv_obj_get_ext_attr(cont);
