 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_led_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_led_set_bright(lv_obj_t * led, uint8_t bright)
{
    /*Set the brightness*/
 ...
 * @param led pointer to a LED object
 */
LV_FUNC_ATTR void lv_led_on(lv_obj_t * led)
{
 ...
 * @param led pointer to a LED object
 */
LV_FUNC_ATTR void lv_led_off(lv_obj_t * led)
{
 ...
 * @param led pointer to a LED object
 */
LV_FUNC_ATTR void lv_led_toggle(lv_obj_t * led)
{
 ...
 */
LV_FUNC_ATTR uint8_t lv_led_get_bright(const lv_obj_t * led)
{
    lv_led_ext_t * ext = lv_obj_get_ext_attr(led);
    return ext->bright;
}
 ...
 */
LV_FUNC_ATTR static bool lv_led_design(lv_obj_t * led, const lv_area_t * mask, lv_design_mode_t mode)
{
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_led_signal(lv_obj_t * led, lv_signal_t sign, void * param)
{
    lv_res_t res;
