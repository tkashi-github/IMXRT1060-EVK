 ...
 */
LV_FUNC_ATTR lv_obj_t * lv_sw_create(lv_obj_t * par, const lv_obj_t * copy)
{
 ...
 */
LV_FUNC_ATTR void lv_sw_on(lv_obj_t * sw, lv_anim_enable_t anim)
{
 ...
 */
LV_FUNC_ATTR void lv_sw_off(lv_obj_t * sw, lv_anim_enable_t anim)
{
#if LV_USE_ANIMATION == 0
    anim = LV_ANIM_OFF;
#endif
 ...
 */
LV_FUNC_ATTR bool lv_sw_toggle(lv_obj_t * sw, lv_anim_enable_t anim)
{
#if LV_USE_ANIMATION == 0
    anim = LV_ANIM_OFF;
#endif
 ...
 */
LV_FUNC_ATTR void lv_sw_set_style(lv_obj_t * sw, lv_sw_style_t type, const lv_style_t * style)
{
    lv_sw_ext_t * ext = lv_obj_get_ext_attr(sw);
...
LV_FUNC_ATTR void lv_sw_set_anim_time(lv_obj_t * sw, uint16_t anim_time)
{
#if LV_USE_ANIMATION
    lv_sw_ext_t * ext = lv_obj_get_ext_attr(sw);
 ...
 */
LV_FUNC_ATTR const lv_style_t * lv_sw_get_style(const lv_obj_t * sw, lv_sw_style_t type)
{
...
LV_FUNC_ATTR uint16_t lv_sw_get_anim_time(const lv_obj_t * sw)
{
 ...
 */
LV_FUNC_ATTR static lv_res_t lv_sw_signal(lv_obj_t * sw, lv_signal_t sign, void * param)
{
    lv_sw_ext_t * ext = lv_obj_get_ext_attr(sw);
