 ...
 *  STATIC VARIABLES
 **********************/
LV_BSS_ATTR static bool lv_task_run  = false;
LV_BSS_ATTR static uint8_t idle_last = 0;
LV_BSS_ATTR static bool task_deleted;
LV_BSS_ATTR static bool task_created;
 ...
 */
LV_FUNC_ATTR void lv_task_core_init(void)
{
 ...
 */
LV_FUNC_ATTR lv_task_t * lv_task_create_basic(void)
{
 ...
 */
LV_FUNC_ATTR lv_task_t * lv_task_create(lv_task_cb_t task_cb, uint32_t period, lv_task_prio_t prio, void * user_data)
{
 ...
 */
LV_FUNC_ATTR void lv_task_set_cb(lv_task_t * task, lv_task_cb_t task_cb)
{
 ...
 */
LV_FUNC_ATTR void lv_task_del(lv_task_t * task)
{
 ...
 */
LV_FUNC_ATTR void lv_task_set_prio(lv_task_t * task, lv_task_prio_t prio)
{
 ...
 */
LV_FUNC_ATTR void lv_task_set_period(lv_task_t * task, uint32_t period)
{
    task->period = period;
}
 ...
 * @param task pointer to a lv_task.
 */
LV_FUNC_ATTR void lv_task_ready(lv_task_t * task)
{
 ...
 * @param task pointer to a lv_task.
 */
LV_FUNC_ATTR void lv_task_once(lv_task_t * task)
{
    task->once = 1;
}
 ...
 * @param task pointer to a lv_task.
 */
LV_FUNC_ATTR void lv_task_reset(lv_task_t * task)
{
 ...
 */
LV_FUNC_ATTR void lv_task_enable(bool en)
{
    lv_task_run = en;
}
 ...
 */
LV_FUNC_ATTR uint8_t lv_task_get_idle(void)
{
    return idle_last;
}
 ...
 */
LV_FUNC_ATTR static bool lv_task_exec(lv_task_t * task)
{
    bool exec = false;
