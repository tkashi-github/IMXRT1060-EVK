 ...
 *  STATIC VARIABLES
 **********************/
LV_BSS_ATTR static uint32_t last_task_run;
LV_BSS_ATTR static bool anim_list_changed;
 ...
 */
LV_FUNC_ATTR void lv_anim_core_init(void)
{
 ...
 */
LV_FUNC_ATTR void lv_anim_init(lv_anim_t * a)
{
 ...
 */
LV_FUNC_ATTR void lv_anim_create(lv_anim_t * a)
{
 ...
 */
LV_FUNC_ATTR bool lv_anim_del(void * var, lv_anim_exec_xcb_t exec_cb)
{
    lv_anim_t * a;
    lv_anim_t * a_next;
    bool del = false;
 ...
 */
LV_FUNC_ATTR uint16_t lv_anim_count_running(void)
{
    uint16_t cnt = 0;
    lv_anim_t * a;
 ...
 */
LV_FUNC_ATTR uint16_t lv_anim_speed_to_time(uint16_t speed, lv_anim_value_t start, lv_anim_value_t end)
{
 ...
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_linear(const lv_anim_t * a)
{
 ...
 * @return the current value to set
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_ease_in(const lv_anim_t * a)
{
    /*Calculate the current step*/
    uint32_t t;
    if(a->time == a->act_time)
 ...
 * @return the current value to set
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_ease_out(const lv_anim_t * a)
{
    /*Calculate the current step*/
 ...
 * @return the current value to set
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_ease_in_out(const lv_anim_t * a)
{
    /*Calculate the current step*/
 ...
 * @return the current value to set
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_overshoot(const lv_anim_t * a)
{
    /*Calculate the current step*/
 ...
 * @return the current value to set
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_bounce(const lv_anim_t * a)
{
    /*Calculate the current step*/
    uint32_t t;
    if(a->time == a->act_time)
 ...
 * @return the current value to set
 */
LV_FUNC_ATTR lv_anim_value_t lv_anim_path_step(const lv_anim_t * a)
{
 ...
 * @param param unused
 */
LV_FUNC_ATTR static void anim_task(lv_task_t * param)
{
    (void)param;
 ...
 * */
LV_FUNC_ATTR static bool anim_ready_handler(lv_anim_t * a)
{
