 ...
 **********************/
#if LV_MEM_CUSTOM == 0
LV_BSS_ATTR static uint8_t * work_mem;
#endif

LV_BSS_ATTR static uint32_t zero_mem; /*Give the address of this variable if 0 byte should be allocated*/
 ...
 */
LV_FUNC_ATTR  void lv_mem_init(void)
{
#if LV_MEM_CUSTOM == 0
 ...
 */
LV_FUNC_ATTR  void * lv_mem_alloc(uint32_t size)
{
    if(size == 0) {
        return &zero_mem;
    }
 ...
 */
LV_FUNC_ATTR  void lv_mem_free(const void * data)
{
...
LV_FUNC_ATTR  void * lv_mem_realloc(void * data_p, uint32_t new_size)
{
 ...
 */
LV_FUNC_ATTR  void lv_mem_defrag(void)
{
#if LV_MEM_CUSTOM == 0
    lv_mem_ent_t * e_free;
    lv_mem_ent_t * e_next;
 ...
 */
LV_FUNC_ATTR  void lv_mem_monitor(lv_mem_monitor_t * mon_p)
{
    /*Init the data*/
...
LV_FUNC_ATTR  uint32_t lv_mem_get_size(const void * data)
{
 ...
 */
LV_FUNC_ATTR  static lv_mem_ent_t * ent_get_next(lv_mem_ent_t * act_e)
{
 ...
 */
LV_FUNC_ATTR  static void * ent_alloc(lv_mem_ent_t * e, uint32_t size)
{
    void * alloc = NULL;
 ...
 */
LV_FUNC_ATTR  static void ent_trunc(lv_mem_ent_t * e, uint32_t size)
{
#ifdef LV_MEM_ENV64
    /*Round the size up to 8*/
    if(size & 0x7) {
