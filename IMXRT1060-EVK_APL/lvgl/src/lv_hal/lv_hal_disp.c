 ...
 *  STATIC VARIABLES
 **********************/
LV_BSS_ATTR static lv_disp_t * disp_def;
 ...
 */
LV_FUNC_ATTR void lv_disp_drv_init(lv_disp_drv_t * driver)
{
 ...
 */
LV_FUNC_ATTR void lv_disp_buf_init(lv_disp_buf_t * disp_buf, void * buf1, void * buf2, uint32_t size_in_px_cnt)
{
 ...
 */
LV_FUNC_ATTR lv_disp_t * lv_disp_drv_register(lv_disp_drv_t * driver)
{
 ...
 */
LV_FUNC_ATTR void lv_disp_drv_update(lv_disp_t * disp, lv_disp_drv_t * new_drv)
{
 ...
 */
LV_FUNC_ATTR void lv_disp_remove(lv_disp_t * disp)
{
 ...
 */
LV_FUNC_ATTR void lv_disp_set_default(lv_disp_t * disp)
{
    disp_def = disp;
}
 ...
 */
LV_FUNC_ATTR lv_disp_t * lv_disp_get_default(void)
{
    return disp_def;
}
 ...
 */
LV_FUNC_ATTR lv_coord_t lv_disp_get_hor_res(lv_disp_t * disp)
{
 ...
 */
LV_FUNC_ATTR lv_coord_t lv_disp_get_ver_res(lv_disp_t * disp)
{
    if(disp == NULL) disp = lv_disp_get_default();
 ...
 */
LV_FUNC_ATTR bool lv_disp_get_antialiasing(lv_disp_t * disp)
{
#if LV_ANTIALIAS == 0
    return false;
#else
 ...
 */
LV_FUNC_ATTR void lv_disp_flush_ready(lv_disp_drv_t * disp_drv)
{
 ...
 */
LV_FUNC_ATTR lv_disp_t * lv_disp_get_next(lv_disp_t * disp)
{
    if(disp == NULL)
 ...
 */
LV_FUNC_ATTR lv_disp_buf_t * lv_disp_get_buf(lv_disp_t * disp)
{
 ...
 */
LV_FUNC_ATTR uint16_t lv_disp_get_inv_buf_size(lv_disp_t * disp)
{
    return disp->inv_p;
}
 ...
 */
LV_FUNC_ATTR void lv_disp_pop_from_inv_buf(lv_disp_t * disp, uint16_t num)
{
 ...
 */
LV_FUNC_ATTR bool lv_disp_is_double_buf(lv_disp_t * disp)
{
 ...
 * @return true: double buffered; false: not double buffered
 */
LV_FUNC_ATTR bool lv_disp_is_true_double_buf(lv_disp_t * disp)
{
