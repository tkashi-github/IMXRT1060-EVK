...
__attribute__((section(".bss.$SharedDATA"))) static SemaphoreHandle_t g_eventTransferComplete;
/*! @brief Card detect event. */
__attribute__((section(".bss.$SharedDATA"))) static SemaphoreHandle_t g_eventCardDetect;
