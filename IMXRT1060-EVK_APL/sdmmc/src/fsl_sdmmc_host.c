...
__attribute__((section(".data.$SharedDATA"))) static volatile bool s_sdInsertedFlag = false;
__attribute__((section(".data.$SharedDATA"))) static volatile status_t s_reTuningFlag = false;
/*******************************************************************************
 * Code
 ******************************************************************************/
static void SDMMCHOST_DetectCardByGpio(const sdmmchost_detect_card_t *cd)
