 ...
 */
FLAC_API static void FLAC__MD5Transform(FLAC__uint32 buf[4], FLAC__uint32 const in[16])
{
...
FLAC_API static void byteSwap(FLAC__uint32 *buf, uint32_t words)
{
...
FLAC_API static void byteSwapX16(FLAC__uint32 *buf)
{
	register FLAC__uint32 x;
 ...
 * of bytes.
 */
FLAC_API static void FLAC__MD5Update(FLAC__MD5Context *ctx, FLAC__byte const *buf, uint32_t len)
{
	FLAC__uint32 t;
 ...
 */
FLAC_API void FLAC__MD5Init(FLAC__MD5Context *ctx)
{
 ...
 */
FLAC_API void FLAC__MD5Final(FLAC__byte digest[16], FLAC__MD5Context *ctx)
{
 ...
 */
FLAC_API static void format_input_(FLAC__multibyte *mbuf, const FLAC__int32 * const signal[], uint32_t channels, uint32_t samples, uint32_t bytes_per_sample)
{
 ...
 */
FLAC_API FLAC__bool FLAC__MD5Accumulate(FLAC__MD5Context *ctx, const FLAC__int32 * const signal[], uint32_t channels, uint32_t samples, uint32_t bytes_per_sample)
{
	...
	if (ctx->capacity < bytes_needed) {
		if (0 == (ctx->internal_buf.p8 = safe_realloc_(ctx->internal_buf.p8, bytes_needed, __FUNCTION__, __LINE__))) {
			if (0 == (ctx->internal_buf.p8 = safe_malloc_(bytes_needed, __FUNCTION__, __LINE__))) {
				ctx->capacity = 0;
				return false;
			}
		}
